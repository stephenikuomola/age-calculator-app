...
/** Class representing the first and last day of the month */ class Month {
    startDate = 1;
    /**
...
class AppComponent {
   ...
   */ #validateDate(year, month, day) {
        ...
        if (checkIndexMonth || checkMaxYear || checkMinYear || checkMinDay || checkMaxDay) {
            if (indexedMonth < 0 || indexedMonth > 11) this.#showErrorMessage(this.#monthInput, "Must be a valid month");
            if (year > currentYear) this.#showErrorMessage(this.#yearInput, "Must be in the past");
            else if (year < epochYear) this.#showErrorMessage(this.#yearInput, "Must be more than 1970");
            if (day < monthsInAYear[indexedMonth]?.startDate || day > monthsInAYear[indexedMonth]?.endDate) this.#showErrorMessage(this.#dayInput, "Must be a valid date");
...
},{}]},["gEwwu","1SICI"], "1SICI", "parcelRequire3b2a")
